      ...
      <span class="navbar-toggler-icon"></span>
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-lg-none d-xl-none">
                  <a class="nav-link" href="#"><i class="fas text-dark fa-shopping-cart mr-2"></i>Cart</a>
                </li>
            </ul>
        </div>
        <ul class="navbar-nav d-none d-lg-flex d-xl-flex d-md-none" >
            ...
            <li class="nav-item">
                <a href="#" class="nav-link"><i class="fas fa-shopping-cart text-dark icon mr-2"></i>Cart</a>
            </li>
        </ul>
</nav>

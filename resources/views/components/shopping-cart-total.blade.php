<div class="card col-sm-12 offset-md-1 col-md-4">
    <div class="card-title border-bottom font-weight-bolder mt-3">
    ...
    <div class="card-body">
        ...
        <div class="row mt-2 p-2 border">
            <h5 class="col-sm-12">Payment Options</h5>
            <button class="col-sm-12 mt-4 btn btn-primary">PlaceHolder</button>
        </div>
    </div>
</div>
